...
//	// n = n + y + 7 with y in an outer environment
//	env := object.NewEnvironment()
//	env.Set("y", createInteger(7))
//	env = object.NewEnclosedEnvironment(env)
//	env.Set("n", createInteger(9))
//
//	infix := createN1Infix("y", "+", *createInteger(7)) // y + 7
//	infix = createN1Infix("n", "+", infix)              // n + (y + 7)
//	infix = createN1Infix("n", "=", infix)              // n = (n + (y + 7))
//
...
//	}
//	assert.Equal(test.T(), "n", leftIdent.Value)
...
//	}
//	assert.Equal(test.T(), "n", originalIdentifier.Value)
//
...
//	}
//	assert.Equal(test.T(), "n", originalIdentifier1.Value)
//}
